...
option_30 = "Network-Info-Scanner"

option_31 = "Proxy(Beta)"
option_32 = "ddos(Beta)"
option_33 = "ddos2(Beta)"
option_34 = "web-ip-info"
option_35 = "web-security(Beta)"
option_36 = "Soon"
option_37 = "Soon"
option_38 = "Soon"
option_39 = "Soon"

option_40 = "Fivem-Spoofer"
option_41 = "gift-gen(Beta)"
option_42 = "passwords-gen"
option_43 = "soon"
option_44 = "soon"
option_45 = "soon"
option_46 = "Soon"
...
option_80 = "web-clone"
option_81 = "cookies-from-browser"
option_82 = "TikTok-Downloader"
option_83 = "QR-code-generator"
option_84 = "soon"
option_85 = "soon"

option_86 = "username-osint2"
option_87 = "steam-osint"
option_88 = "tiktok-osint"
option_89 = "valorant-osint"
option_90 = "Soon"
option_91 = "Soon"
option_92 = "Soon"
option_93 = "Soon"
...
option_80_txt = f"{red}[{white}80{red}]{white} " + option_80.ljust(30)[:30].replace("-", " ")
option_81_txt = f"{red}[{white}81{red}]{white} " + option_81.ljust(30)[:30].replace("-", " ")
option_82_txt = f"{red}[{white}82{red}]{white} " + option_82.ljust(30)[:30].replace("-", " ")
option_83_txt = f"{red}[{white}83{red}]{white} " + option_83.ljust(30)[:30].replace("-", " ")
option_84_txt = f"{red}[{white}84{red}]{white} " + option_84.ljust(30)[:30].replace("-", " ")
option_85_txt = f"{red}[{white}85{red}]{white} " + option_85.ljust(30)[:30].replace("-", " ")
option_86_txt = f"{red}[{white}86{red}]{white} " + option_86.ljust(30)[:30].replace("-", " ")
option_87_txt = f"{red}[{white}87{red}]{white} " + option_87.ljust(30)[:30].replace("-", " ")
option_88_txt = f"{red}[{white}88{red}]{white} " + option_88.ljust(30)[:30].replace("-", " ")
option_89_txt = f"{red}[{white}89{red}]{white} " + option_89.ljust(30)[:30].replace("-", " ")
option_90_txt = f"{red}[{white}90{red}]{white} " + option_90.ljust(30)[:30].replace("-", " ")
option_91_txt = f"{red}[{white}91{red}]{white} " + option_91.ljust(30)[:30].replace("-", " ")
option_92_txt = f"{red}[{white}92{red}]{white} " + option_92.ljust(30)[:30].replace("-", " ")
option_93_txt = f"{red}[{white}93{red}]{white} " + option_93.ljust(30)[:30].replace("-", " ")
option_94_txt = f"{red}[{white}94{red}]{white} " + option_94.ljust(30)[:30].replace("-", " ")
option_95_txt = f"{red}[{white}95{red}]{white} " + option_95.ljust(30)[:30].replace("-", " ")
option_96_txt = f"{red}[{white}96{red}]{white} " + option_96.ljust(30)[:30].replace("-", " ")
option_97_txt = f"{red}[{white}97{red}]{white} " + option_97.ljust(30)[:30].replace("-", " ")
option_98_txt = f"{red}[{white}98{red}]{white} " + option_98.ljust(30)[:30].replace("-", " ")
option_99_txt = f"{red}[{white}99{red}]{white} " + option_99.ljust(30)[:30].replace("-", " ")
option_100_txt = f"{red}[{white}100{red}]{white} " + option_100.ljust(30)[:30].replace("-", " ")
...
menu3 = f""" ┌─ {option_info_txt}                                                                                                {option_next_txt} ─┐
 ├─ {option_site_txt}                                           ┌─────────┐                                          {option_back_txt} ─┤
─┴─┬───────────────────────────────────────────────────┤ Discord ├────────────────────────────────────────────────────┘
   │                                                   └─────────┘                       
...
menu4 = f""" ┌─ {option_info_txt}                                                                                    {option_next_txt} ─┐
 ├─ {option_site_txt} ┌───────────┐                        ┌────────┐                          ┌──────┐  {option_back_txt} ─┤
 └─┬─────────┤    web    ├───────────────┬────────┤ Osint2 ├──────────────────────────┤ soon ├────────────┘
   │         └───────────┘               │        └────────┘                          └──────┘
   ├─ {option_80_txt                    }├─ {option_86_txt                    }
   ├─ {option_81_txt                    }├─ {option_87_txt                    }
   ├─ {option_82_txt                    }├─ {option_88_txt                    }
   └─ {option_83_txt                    }└─ {option_89_txt                    }                                                                                                                      
...
while True:
 ...
 └─{white}$ {reset}"""))
      ...
      if choice in ['N', 'n', 'NEXT', 'Next', 'next']:
         ...
         print(f"\n{BEFORE + current_time_hour() + AFTER} {INFO} Starting Network-Info-Scanner...")
         StartProgram("Network-Info-Scanner.py")
         continue
      ...
      options = {
         ...
         '97': option_97, '98': option_98, '99': option_99, '100': option_100,
      }
